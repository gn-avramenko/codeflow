...
public class SimpleRouteFlowConfigurator implements FlowConfigurator {

    @Override
    public void configure(FlowBuilder fb) {
        fb.route(SimpleRoute.class);
        fb.routeInjection(SimpleRouteInjection.class, InjectionSubRoute.class);
    }
}
